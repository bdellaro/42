...
void	ft_error_print(char **argv)
{
	...
	ft_printf("Please enter :\n====>   \033[0;32m%s\033[0m and \033[0;32m./maps/*.ber\033[0m\n   Or chose between :\n", argv[0]);
	ft_printf("====>	\033[0;32m%s\033[0m and -> \033[0;32mSmall\033[0m", argv[0]);
	ft_printf("\n                      -> \033[0;32mBig\033[0m");
	ft_printf("\n                      -> \033[0;32mMedium\033[0m\n");
	exit (EXIT_FAILURE);
}
...
void	ft_map_check(char **argv)
{
	...
	if (ft_strnstr(argv[1], "./maps/", 8) && ft_strnstr(argv[1], ".ber",
	ft_strlen(argv[1])))
	...
	if (!ft_strncmp(upper, "MEDIUM", 6) && !ft_strncmp(upper, "MEDIUM",
	7) != 0)
		ft_first_init(MEDIUM, upper, argv);
	if (!ft_strncmp(upper, "BIG", 3) && !ft_strncmp(upper, "BIG",
	4) != 0)
